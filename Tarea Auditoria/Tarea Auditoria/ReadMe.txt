========================================================================
   APLICACIÓN: Tarea Auditoria Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Tarea Auditoria.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Tarea Auditoria.

Tarea Auditoria.vcxproj
...
Tarea Auditoria.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Tarea Auditoria.pch y un archivo de tipos 
